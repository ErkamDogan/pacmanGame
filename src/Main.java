...
//        resetPoints();
        ...
        coordinates[1][1].makePacman();

        //Handle keyboard inputs(events)
        layout.setOnKeyPressed(e -> {
            if (e.getCode() == KeyCode.UP) {
                if (!coordinates[pacman.getPosition().getX()][pacman.getPosition().getY() - 1].isBox()) {
                    if (coordinates[pacman.getPosition().getX()][pacman.getPosition().getY() -1].isPoint()) {
                        points++;
                        updatePointer();
                        layout.getChildren().remove(
                                coordinates[pacman.getPosition().getX()][pacman.getPosition().getY() -1].getHoldedObject()
                        );
                    }
                    coordinates[pacman.getPosition().getX()][pacman.getPosition().getY()-1].makePacman();
                    coordinates[pacman.getPosition().getX()][pacman.getPosition().getY()].makeEmpty();
            ...
            if (e.getCode() == KeyCode.RIGHT) {
                if (!coordinates[pacman.getPosition().getX()+1][pacman.getPosition().getY()].isBox()) {
                    if (coordinates[pacman.getPosition().getX() + 1][pacman.getPosition().getY()].isPoint()) {
                        points++;
                        updatePointer();
                        layout.getChildren().remove(
                                coordinates[pacman.getPosition().getX() + 1][pacman.getPosition().getY()].getHoldedObject()
                        );
                    }

                    coordinates[pacman.getPosition().getX()+1][pacman.getPosition().getY()].makePacman();
                    coordinates[pacman.getPosition().getX()][pacman.getPosition().getY()].makeEmpty();
